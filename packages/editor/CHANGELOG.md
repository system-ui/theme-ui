...
- chore(editor): annotate a type that should be inferred :( ([@hasparus](https://github.com/hasparus))
- refactor(editor): fix type errors ([@hasparus](https://github.com/hasparus))
- chore: add missing dependency ([@hasparus](https://github.com/hasparus))
- fix(editor): assert that color is string ([@hasparus](https://github.com/hasparus))

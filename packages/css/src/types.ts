...
import { ColorScaleCSSProperties, OpacitiesCSSProperties, SpaceCSSProperties } from './scales'
...
interface OverwriteCSSProperties extends ColorScaleCSSProperties, OpacitiesCSSProperties, SpaceCSSProperties {
  /**

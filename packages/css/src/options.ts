...
// TODO: Remove this before 0.7.0 release.
/**
 * @internal
...
export function __internalGetUseRootStyles(theme: Theme = {}) {
  const useRootStyles = theme.config?.useRootStyles
  const root = useRootStyles != null

  return {
    scope: root ? 'html' : 'body',
    rootStyles: root ? useRootStyles : theme.useBodyStyles,
  }
}

...
- chore(typography): Move declarations.d.ts out of test dir ([@hasparus](https://github.com/hasparus))
...
- Fix type export ([@alexanderchan](https://github.com/alexanderchan))

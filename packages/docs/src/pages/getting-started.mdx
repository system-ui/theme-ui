...
The `global` theme object should be provided in context for use anywhere in your application.
To add the theme,
...
Read more in the [theming docs](/theming).
...
Under the hood, this uses the [`@styled-system/css`](https://styled-system.com/css) utility with Emotion.

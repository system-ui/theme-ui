...
- > Maybe my favorite feature of Theme-UI, responsive styles by passing an array
  > of values that map to your theme's breakpoints: I've never figured out
  > media-queries but this finally makes sense 🙌
  > [Kyle Gill](https://mobile.twitter.com/gill_kyle/status/1146099033875681280)
- > I think Gatsby theme is really great idea... my favorite part is that they
  > folded themes under plugin and extracted out the idea of shadowing and
  > theme-ui. This is quickly becoming one of my favorite frameworks!

...
**Note:** these styles will **not** apply to HTML elements used outside of MDX. To reuse these styles outside of MDX, see the [Styled component](/styled) docs.
...
**Note:** Theme UI does not currently use colors from Typography.js.

...
This allows you to add typographic styles to markdown without the need to pollute the global scope.
...
To style content that is not generated with MDX with `theme.styles`, see the [`BaseStyles`](/api/#base-styles) component.

...
To start, create a layout component that will pages in your application.
Feel free to customize the content and default styles however you need.
...
When no styles are defined, the default styles will still be used.

If a user wants to customize the layout styles, they can add overrides to their theme object.

For example, the following will add colors to the header and footer.

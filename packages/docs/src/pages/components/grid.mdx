...
CSS grid layout component to arrange direct child elements in a tiled grid
layout.
...
The `Grid` component includes custom props for adjusting the grid layout. Each
prop can use the [responsive array][] syntax for mobile-first responsive styles.

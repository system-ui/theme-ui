...
The ThemeProvider component will automatically apply color mode styles to the `<html>` element.
...
The `useColorSchemeMediaQuery` option on the theme configuration

...
This approach isn't required when using `gatsby-plugin-theme-ui` because after rehydration, the custom property
implementation will be replaced with CSS values.
